-- 0150:agent_templates —— AI 员工市场的「用户自定义」供给源
--
-- 编号说明:issue 里写的是 0149,但 0149 已经被 compute_reservations 占用(先合进的主干),
-- 所以顺延到 0150。check-migration-numbering.ts 要求文件名与 journal 严格一一对应、不许重号。
--
